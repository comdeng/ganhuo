 ...
 */
final class TsBakedBezierInterpolator implements Interpolator {
    private static final TsBakedBezierInterpolator INSTANCE = new TsBakedBezierInterpolator();

    public final static TsBakedBezierInterpolator getInstance() {
        return INSTANCE;
    }
     ...
     */
    private TsBakedBezierInterpolator() {
        super();
    }
