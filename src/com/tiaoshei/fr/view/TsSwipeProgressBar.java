 ...
 * trigger a refresh).
 */
final class TsSwipeProgressBar {
    ...
    private static final Interpolator INTERPOLATOR = TsBakedBezierInterpolator.getInstance();
    ...
    public TsSwipeProgressBar(View parent) {
        mParent = parent;
        mColor1 = COLOR1;
        mColor2 = COLOR2;
        mColor3 = COLOR3;
