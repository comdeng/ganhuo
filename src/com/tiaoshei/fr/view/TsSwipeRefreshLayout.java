...
public class TsSwipeRefreshLayout extends ViewGroup {
    ...
    private TsSwipeProgressBar mProgressBar; //the thing that shows progress is going
     ...
     * @param attrs
     */
    public TsSwipeRefreshLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
        ...
        mProgressBar = new TsSwipeProgressBar(this);
