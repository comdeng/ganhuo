...
import com.huimang.ganhuo.adapter.PresentationListAdapter;
...
public class PresentationFragment extends BaseFragment {
    public String defaultUrl = "http://ganhuo.tiaoshei.com/infoq/presentation/";

    @Override
    public void initRecyclerView() {
        // 设置适配器
        mRecyclerView.setAdapter(new PresentationListAdapter(this.getActivity(), this.list));
