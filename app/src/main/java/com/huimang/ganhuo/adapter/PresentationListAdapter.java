...
/**
 * Created by ronnie on 16/8/15.
 */
public class PresentationListAdapter extends RecyclerView.Adapter<PresentationListAdapter.MyViewHolder>{

    Activity activity;
    private List<Article> list = new ArrayList<Article>();

    public PresentationListAdapter(Activity activity, List<Article> list) {
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(this.activity).inflate(R.layout.presentation_list, null);
